...
public class CharaControllerBase : MonoBehaviour
{
    ...
    public virtual void SetUpCharacterController(CharaData charaData, OwnerType ownerType) {
    ...
    protected IEnumerator Attack() {
        ...
        //音声を再生
        SoundManager.instance.PlaySoundByAudioSource(SoundManager.instance.GetCharacterVoiceData(charaData.charaName).clip);
